...
export default function Footer() {
  return (
    <footer className="text-white relative overflow-hidden" style={{background: "linear-gradient(to bottom, #ffffff, #373737)"}}>
      ...
      {/* Footer body */}
      <div className="max-w-7xl mx-auto px-6 pt-12 pb-8 grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-10">
        {/* Logo + socials */}
        <div className="col-span-2 md:col-span-1 flex flex-col gap-4">
          <Image src="/logo.svg" alt="Deforche" width={110} height={36} className="brightness-0 invert" />
          <p className="text-sm text-gray-400 mt-2">Volg ons</p>
        ...
        {/* Bedrijf */}
        <div>
          <h4 className="text-sm font-bold mb-4"><Bliksem />Bedrijf</h4>
        ...
        {/* Diensten */}
        <div>
          <h4 className="text-sm font-bold mb-4"><Bliksem />Diensten</h4>
          <ul className="flex flex-col gap-2 text-sm text-gray-400">
            <li><Link href="/diensten" className="hover:text-white transition-colors">Hardware Engineering</Link></li>
            <li><Link href="/diensten" className="hover:text-white transition-colors">Bordenbouw / Assemblage</Link></li>
            <li><Link href="/diensten" className="hover:text-white transition-colors">Hoog- en Middenspanning</Link></li>
            <li><Link href="/diensten" className="hover:text-white transition-colors">Testing & Indienststelling</Link></li>
            <li><Link href="/diensten" className="hover:text-white transition-colors">Troubleshooting en Onderhoud</Link></li>
          </ul>
        </div>

        {/* Contactgegevens */}
        <div>
          <h4 className="text-sm font-bold mb-4"><Bliksem />Contactgegevens</h4>
          <ul className="flex flex-col gap-2 text-sm text-gray-400">
            <li>De Leiteweg 5A,<br />8020 Ruddervoorde</li>
            <li><a href="mailto:renaat@schakeltechniek.be" className="hover:text-white transition-colors">renaat@schakeltechniek.be</a></li>
            <li><a href="tel:+3249628641" className="hover:text-white transition-colors">+32 496 28 64 15</a></li>
          </ul>
        </div>
      </div>

      {/* Bottom bar */}
      <div className="border-t border-white/10 max-w-7xl mx-auto px-6 py-4 flex flex-wrap gap-4 items-center justify-between text-xs text-gray-500">
      ...
      {/* DEFORCHE watermark */}
      <div className="pointer-events-none select-none overflow-hidden h-16 md:h-20 flex items-end justify-center">
        <span className="text-[60px] md:text-[120px] font-black leading-none tracking-widest text-white/5 uppercase">DEFORCHE</span>
      </div>
    </footer>
  );
}
