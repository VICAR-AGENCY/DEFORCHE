  ...
  return (
    <div className="max-w-7xl mx-auto px-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[15px]">
        ...
        {/* Gele cel met logo + bliksem overlay */}
        <div className="relative bg-(--color-primary) p-6 flex flex-col items-start justify-between gap-4 rounded-[10px] overflow-hidden">
          {/* Bliksem overlay */}
          <svg
            viewBox="0 0 10 14"
            fill="none"
            className="absolute right-4 top-1/2 -translate-y-1/2 w-32 h-44 opacity-20"
          >
